...
//   "AWS", "Machine Learning", "TypeScript", "MongoDB", "Git", "REST APIs","documentation","Story Writing",
...
//     onAnalyze({ user_skills: userSkills, target_role: targetRole });
//   };
...
//           Target Role <span className="text-gray-500">(optional — auto-detected if blank)</span>
//         </label>
...
//             onKeyDown={(e) => e.key === "Enter" && (e.preventDefault(), addSkill(inputSkill))}
...
//             {COMMON_SKILLS.filter((s) => !userSkills.includes(s)).slice(0, 10).map((skill) => (
//               <button
//                 key={skill}
//                 type="button"
...
//         {loading ? (
//           <>
//             <Loader2 className="w-4 h-4 mr-2 animate-spin" /> Analyzing with ML Model...
//           </>
//         ) : (
//           <>
//             <Brain className="w-4 h-4 mr-2" /> Analyze Skill Gap
//           </>
//         )}
//       </Button>
//     </form>
